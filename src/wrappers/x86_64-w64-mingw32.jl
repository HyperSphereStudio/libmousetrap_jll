# Autogenerated wrapper script for libmousetrap_jll for x86_64-w64-mingw32
export mousetrap, mousetrap_file, mousetrap_julia_binding
...
JLLWrappers.@declare_file_product(mousetrap_file)
